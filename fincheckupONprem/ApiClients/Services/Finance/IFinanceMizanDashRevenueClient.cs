...
public interface IFinanceMizanDashRevenueClient : IApiClientBase
{
    ...
    Task<GenericResult<MizanDashRevenueOnGetChartRasyoResponse>> GetChartRasyoAsync([Body] MizanDashRevenueOnGetChartRasyoRequest request, CancellationToken cancellationToken = default);
